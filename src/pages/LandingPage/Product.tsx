        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-8 px-6">
          <div className="self-stretch inline-flex flex-col justify-start items-start gap-6 md:w-1/2">
            ...
            <div className="self-stretch pt-4 inline-flex justify-start items-start gap-4">
              <Link
                to="/register"
                className="px-8 py-4 bg-linear-to-r from-blue-800 to-blue-700 rounded-2xl inline-flex flex-col justify-center items-center cursor-pointer hover:opacity-90 transition text-white text-lg font-bold font-inter leading-7"
              >
                Start Your Blueprint
              </Link>
              <a
                href="#methodology"
                className="px-8 py-4 bg-gray-100 rounded-2xl inline-flex flex-col justify-center items-center cursor-pointer hover:bg-gray-200 transition text-gray-700 text-lg font-bold font-inter leading-7"
              >
                View Methodology
              </a>
            </div>
      ...
      >
        <div className="container mx-auto px-6 flex flex-col justify-start items-start gap-16">
          ...
          <div className="w-full h-64 md:h-80 rounded-3xl relative overflow-hidden flex items-end p-8 md:p-10 text-left shadow-xs border border-gray-100">
            ...
            <div className="relative z-10 flex flxex-col gap-1 max-w-xl">
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="w-full bg-blue-600 rounded-[40px] px-6 py-16 md:py-20 flex flex-col justify-center items-center text-center shadow-xl shadow-blue-900/10 border border-blue-500/20">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full">
              <Link
                to="/register"
                className="font-inter bg-white text-blue-800 font-bold px-7 py-3.5 rounded-xl hover:bg-blue-50 transition-all duration-200 shadow-sm w-full sm:w-auto text-sm tracking-wide text-center cursor-pointer"
              >
